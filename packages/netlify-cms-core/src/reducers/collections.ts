...
const collections = (state: Collections = defaultState, action: ConfigAction) => {
  switch (action.type) {
    case CONFIG_SUCCESS: {
...
export const selectMediaFolders = (config: CmsConfig, collection: Collection, entry: EntryMap) => {
