const gr = {
  ...
  ui: {
    ...
    toast: {
      ...
      missingRequiredField: "Ουπς, χάσατε ένα απαιτούμενο πεδίο. Συμπληρώστε πριν από την αποθήκευση.",
  ...
  workflow: {
    workflow: {
      ...
      description: "%{smart_count} καταχώρηση σε αναμονή για αναθεώρηση, %{readyCount} έτοιμες για Live μετάβαση. |||| %{smart_count} καταχωρήσεις σε αναμονή για αναθεώρηση, %{readyCount} έτοιμες για Live μετάβαση. "
    },
    workflowCard: {
