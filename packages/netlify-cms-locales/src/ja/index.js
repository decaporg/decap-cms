const ja = {
  ...
  editor: {
    ...
    editor: {
      ...
      onDeleteUnpublishedChanges:
        '公開されていない変更も削除されますが、それでもこのエントリを削除しますか？',
  ...
  ui: {
    ...
    toast: {
      onFailToLoadEntries: 'エントリの読み込みに失敗しました。%{detail}',
      onFailToLoadDeployPreview: 'プレビューの読み込みに失敗しました。%{detail}',
      onFailToPersist: 'エントリの保存に失敗しました。%{detail}',
      onFailToDelete: 'エントリの削除に失敗しました。%{details}',
      onFailToUpdateStatus: 'エントリのステータス更新に失敗しました。%{detail}',
      missingRequiredField: '全ての必須項目を入力してください。',
      entrySaved: '保存しました。',
      entryPublished: '公開しました。',
      entryUnpublished: '未公開にしました。',
      onFailToPublishEntry: 'エントリの公開に失敗しました。%{detail}',
      onFailToUnpublishEntry: 'エントリを未公開にするのに失敗しました。%{detail}',
  ...
  workflow: {
    workflow: {
      ...
      newPost: '新規作成',
      description: '%{smart_count}件がレビュー待ち、%{readyCount}件が準備完了です。',
    },
    workflowCard: {
      lastChange: '%{author}が%{date}に更新',
      lastChangeNoAuthor: '最終更新日時：%{date}',
