...
function getDatetimePickerStyles(theme, hasShortcuts) {
  return css`
    .datetime-picker {
      position: relative;
...
function DatetimePickerStyles({ theme, shortcuts }) {
  const hasShortcuts = shortcuts && Object.keys(shortcuts).length > 0;

  return <Global styles={getDatetimePickerStyles(theme, hasShortcuts)} />;
}

export default withTheme(DatetimePickerStyles);
