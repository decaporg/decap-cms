...
import IntegerControl from './Widgets/IntegerControl';
import FloatControl from './Widgets/FloatControl';
...
registry.registerWidget('integer', IntegerControl, NumberPreview);
registry.registerWidget('float', FloatControl, NumberPreview);
