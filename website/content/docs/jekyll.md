...
Follow the directions in the docs [to enable Identity + Git Gateway and add the Indentity Widget](https://www.netlifycms.org/docs/add-to-your-site/#enable-identity-and-git-gateway)
