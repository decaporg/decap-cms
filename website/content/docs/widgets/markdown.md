...
- **Options:**
  ...
  - `buttons`: an array of strings representing the formatting buttons to display, all buttons shown by default. Buttons include: `bold`, `italic`, `code`, `link`, `headings`, `quote`, `code-block`, `bulleted-list`, and `numbered-list`.
- **Example:**
