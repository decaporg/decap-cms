...
| `squash_merges`  | `false`                                                        | If `true`, pull requests are merged using the “squash and merge” method, reducing clutter in the content repository’s commit history. Optional.                                                                                  |
